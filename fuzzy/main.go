...
func main() {
	...
	words := []string{"bob", "your", "uncle", "dynamite", "delicate", "biggest", "big", "bigger", "aunty", "you're", "32GB"}
	model.Train(words)
	...
	fmt.Println("	Two char test (32G) : ", model.SpellCheck("32G"))
	...
	suggested, _ := model.Autocomplete("32")
